...
public class ClienteDAO implements IClienteDAO{
    ...
    public boolean buscarClientePorId(Cliente cliente) {
        ...
        try{
            ...
            System.out.println("El error a buscar cliente por id: "+e.getMessage());
        }
        finally {
            try {
                con.close();
    ...
    public boolean agregarCliente(Cliente cliente) {
        ...
        try {
           ...
           return true;
            ...
            System.out.println("Ocurrio un error al agregar cliente: "+e.getMessage());
        }
        finally {
            try {
                con.close();
    ...
    public boolean modificarCliente(Cliente cliente) {
        ...
        try{
            ...
            System.out.println("Ocurrio un error al modificar cliente: "+e.getMessage());
        }
        finally {
            try {
                con.close();
